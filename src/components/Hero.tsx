        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              CodeChefs 🧑‍💻👩‍🍳
              <span className="block text-2xl lg:text-2xl xl:text-3xl text-gray-600 dark:text-gray-400">
                Cooking Up Code, One Byte at a Time!
              </span>
            </h1>
            <p className="py-5 text-lg leading-normal text-gray-500 lg:text-lg xl:text-xl dark:text-gray-300">
              CodeChefs connects university students with hackathons, coding
              competitions, and tech events. Join us to find your next team and
              innovate!
            </p>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Proudly partnered with <span className="text-indigo-600">100+</span>{" "}
